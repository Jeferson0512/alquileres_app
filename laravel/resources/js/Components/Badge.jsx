const VARIANTS = {
    success: 'bg-success-tint text-success dark:bg-green-400/10',
    warning: 'bg-warning-tint text-warning dark:bg-amber-400/10',
    danger: 'bg-danger-tint text-danger dark:bg-red-400/10',
