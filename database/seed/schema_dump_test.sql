...
CREATE TABLE `cobros_mensuales` (
  ...
  KEY `idx_cobro_ocupacion` (`id_ocupacion`),
  CONSTRAINT `fk_cobro_ocupacion` FOREIGN KEY (`id_ocupacion`) REFERENCES `ocupacion_unidad` (`id_ocupacion`),
...
--
-- Table structure for table `comprobante_correlativos`
--

DROP TABLE IF EXISTS `comprobante_correlativos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `comprobante_correlativos` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `comprobante_correlativos_serie_unique` (`serie`)
...
CREATE TABLE `comprobantes_pago` (
  ...
  `leido_en_inquilino` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `ocupacion_unidad` (
  ...
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `updated_at` datetime DEFAULT NULL ON UPDATE current_timestamp(),
  `activa_flag` int(10) unsigned GENERATED ALWAYS AS (if(`estado` = _utf8mb4'ACTIVO',`id_unidad`,NULL)) STORED,
...
CREATE TABLE `pagos` (
  ...
  KEY `pagos_numero_comprobante_index` (`numero_comprobante`),
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_pagos_bu` BEFORE UPDATE ON `pagos` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_pagos_au` AFTER UPDATE ON `pagos` FOR EACH ROW BEGIN
...
CREATE TABLE `pagos_auditoria` (
  ...
  `payload_before` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `payload_after` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  ...
  CONSTRAINT `pagos_auditoria_chk_1` CHECK (json_valid(`payload_before`)),
  CONSTRAINT `pagos_auditoria_chk_2` CHECK (json_valid(`payload_after`))
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_pagos_detalle_bi` BEFORE INSERT ON `pagos_detalle` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_pagos_detalle_ai` AFTER INSERT ON `pagos_detalle` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_pagos_detalle_bu` BEFORE UPDATE ON `pagos_detalle` FOR EACH ROW BEGIN
    DECLARE v_id_cobro_pago INT UNSIGNED;
    DECLARE v_estado_pago VARCHAR(20);
    DECLARE v_monto_pago DECIMAL(12,2);
    DECLARE v_id_cobro_detalle BIGINT UNSIGNED;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_pagos_detalle_au` AFTER UPDATE ON `pagos_detalle` FOR EACH ROW BEGIN
    DECLARE v_id_cobro INT UNSIGNED;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_pagos_detalle_ad` AFTER DELETE ON `pagos_detalle` FOR EACH ROW BEGIN
    DECLARE v_id_cobro INT UNSIGNED;
...
CREATE TABLE `payment_gateway_transactions` (
  ...
  CONSTRAINT `payment_gateway_transactions_chk_1` CHECK (json_valid(`raw_payload`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tarifas_auditoria` (
  ...
  CONSTRAINT `tarifas_auditoria_chk_1` CHECK (json_valid(`payload_before`)),
  CONSTRAINT `tarifas_auditoria_chk_2` CHECK (json_valid(`payload_after`))
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Temporary view structure for view `vw_cobros_resumen`
--
